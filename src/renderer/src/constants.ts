...
export const HERMES_AGENT_INSTALL_REF = "v2026.5.16";
export const UNIX_INSTALL_CMD =
  `curl -fsSL https://raw.githubusercontent.com/NousResearch/hermes-agent/${HERMES_AGENT_INSTALL_REF}/scripts/install.sh | bash`;
export const INSTALL_CMD_UNIX = UNIX_INSTALL_CMD;
export const WINDOWS_INSTALL_CMD =
  `powershell -NoProfile -ExecutionPolicy Bypass -c "$hermesHome = Join-Path $env:USERPROFILE '.hermes'; $installDir = Join-Path $hermesHome 'hermes-agent'; $installer = [ScriptBlock]::Create((irm https://raw.githubusercontent.com/NousResearch/hermes-agent/${HERMES_AGENT_INSTALL_REF}/scripts/install.ps1 -UseBasicParsing)); & $installer -SkipSetup -HermesHome $hermesHome -InstallDir $installDir"`;
